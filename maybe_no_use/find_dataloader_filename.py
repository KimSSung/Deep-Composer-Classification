...
np.save('/data/midi820_128ch/find_filename/Country/new_country_trainset.npy', new_country_trainset)
print('new country trainset saved!')

np.save('/data/midi820_128ch/find_filename/Country/new_country_validset.npy', new_country_validset)
