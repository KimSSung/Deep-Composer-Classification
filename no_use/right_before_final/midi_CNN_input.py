...
for genre in tqdm(genres):
    ...
    for file in glob.glob(genre_dir + "*.mid"):
        try:
            ...
            #make into (2x400x128)
            channel2_input = []
            channel2_input.append(note_matrix_2d_instr)
            channel2_input.append(note_matrix_2d_vel)
        ...
        # plt.show()
            genre_data.append(channel2_input)
    ...
    np.save('/data/midi820_cnn/'+genre+'_input' , genre_3d_array) #save as .npy
