...
SAVE_PATH = '/nfs/home/kssung/midiclass/new_midiset/tensors/'
...
genre = ['Blues','HipHopRap','Jazz','NewAge','Pop']
#genre = ['Classical']
...
print('genres tensor num [Blues,HipHopRap,Jazz,NewAge,Pop]:', tot_tensor_num)
