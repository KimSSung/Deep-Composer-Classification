                ...
                for note in range(0, 128):
                    if segment_tree[track][note]:
                        for key in segment_tree[track][note].keys():
                            ...
                            stretched_segment_tree[track][note][new_key].append( int(segment_tree[track][note][key][1] * (2-tempo_mul)))
            ...
            for track in range(0, X.shape[0]):
                for time in range(0, 400):
                    for note in range(0,128):
                        ...
                        elif (stretch_start<= time and time< stretch_start + int(stretch_duration * tempo_mul)):
