...
for genre in tqdm(genres):
    ...
    np.save('/data/midi820_fgsm/'+genre+'_input' , genre_3d_array) #save as .npy
    np.save('/data/midi820_fgsm/'+genre+'_filename' , genre_filename_array) #save as .npy
