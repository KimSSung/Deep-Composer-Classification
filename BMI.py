...
class BertForMidiClassification(BertPreTrainedModel):
    ...
    Inputs:
        `input_ids`: total # 369 + 3(CLS,SEP,PAD). [batch_size, sequence_length]
                    Here each one hot vector of sequence has '369 + 3' dimension
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None):
        ...
        return F.softmax(out, dim=1) # softmax for dim (dim=1) /  not batch_size(dim=0)
