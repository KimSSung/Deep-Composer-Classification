...
for genre_index in range (0,len(genre)):
    genre_dir = '/nfs/home/ryan0507/pycharm_maincomputer/midiset/' +  genre[genre_index] + '/'
    file_dir = []
    file_name = []
    ...
    for cur_file in range(0,len(file_dir)):
        ...
        try:
            ...
            data.to_csv('/nfs/home/ryan0507/pycharm_maincomputer/csv/'+str(genre[genre_index]) + '/' +file_name[cur_file] +'.csv' ,header=False, index = False)
            ...
            with open("/nfs/home/ryan0507/pycharm_maincomputer/Tensor_Data_"+ str(genre[genre_index]) +".txt","a") as f:
            ...
            with open("/nfs/home/ryan0507/pycharm_maincomputer/Error_Record_"+ str(genre[genre_index]) +".txt", "a") as f:
