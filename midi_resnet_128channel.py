	  ...
	  with torch.no_grad():  # important!!! for validation
		...
		if avg_valloss < min_valloss:
			...
			torch.save({'epoch':epoch,
						...
						'loss':avg_valloss,
						'acc':avg_valacc}, MODEL_SAVE_PATH + 'ResNet50_valloss_' + str(avg_valloss) + '_acc_' + str(avg_valacc) + '.pt')
			print('model saved!')
			# load:
...
model = resnet18(128, 3)
model.eval()
checkpoint = torch.load('/data/midi820_128ch/model/bestmodel/ResNet50_valloss_0.6343_acc_83.33.pt')
