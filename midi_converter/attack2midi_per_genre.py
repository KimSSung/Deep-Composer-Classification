...
for genre in GENRES:
    ...
    for idx in range(len(load_full_data)):
                ...
                for col in range(0, 128):
                    ...
                    if load_data[channel_instrument][row][col] == 0:
                        ...
                        if (
                            len(
                                track_string_list[
                                    current_used_instrument.index(channel_instrument)
                                ]
                            )
                            != 0
                        ):
                            ...
                            velocity = load_data[channel_instrument][row][
                                col
                            ...
                            note_off_list[track_num].append(
                                [track_num, end_delta_time, channel, pitch, velocity]
                            )
                        else:
        ...
        with open(
            output_file_dir + genre + "/New_" + only_file_name, "wb"
        ) as output_file:
